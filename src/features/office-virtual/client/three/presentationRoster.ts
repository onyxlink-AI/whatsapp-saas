...
const PRESENTATION_AGENTS: Record<string, OfficeSceneAgent> = {
  coordinator: {
    ...
    color: '#c4b5fd',
    status: 'working',
    appearance: { shirtColor: '#312e81', pantsColor: '#0f172a', skinColor: '#f4c99b', hairColor: '#292524' },
  },
  'lead-intake': {
    id: 'lead-intake',
  ...
  'specialist-4': {
    ...
    color: '#a78bfa',
    status: 'working',
    appearance: { shirtColor: '#7c3aed', pantsColor: '#152235', skinColor: '#f2c6a0', hairColor: '#6b3f25' },
  },
  'specialist-5': {
    id: 'specialist-5',
